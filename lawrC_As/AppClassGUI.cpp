...
#pragma endregion
	...
	if (m_bGUI_Main)
	{
		...
		ImGui::Begin(sAbout.c_str(), (bool*)0, window_flags);
		{
			...
			ImGui::Text("Octants: %d\n", m_pRoot->GetOctantCount()); // Uncommented, now shows number of octants in UI
			...
			ImGui::Separator();
			ImGui::Text(" I: Increment Octree subdivision\n");
			ImGui::Text(" K: Decrement Octree subdivision\n");
			ImGui::Separator();
			ImGui::Text(" O: On/Off Visuals"); // Tells you that you can turn on/off visuals with the O key
			ImGui::Separator();
			ImGui::Text("Arrow Keys: Move Steve"); // Tells you that you can turn on/off visuals with the O key
			ImGui::TextColored(ImColor(0, 255, 255), "A Star\n");
		}
		ImGui::End();
	}
